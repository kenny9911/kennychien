...
const I18N = {
  'en': {
    ...
    services: [
      { n: '01', t: 'AI Application Launch', d: 'One high-value use case, taken from whiteboard to deployed application — with your team trained along the way.', m: '6–12 WEEKS · OUTCOME-BASED' },
      { n: '02', t: 'Agentic Architecture & Ontology', d: 'Design the ontology your enterprise will run on: entities, actions, permissions — and the agents that traverse them.', m: 'ADVISORY · ARCHITECTURE' },
      { n: '03', t: 'Forward Deployed Engineering', d: 'I embed with your engineers as an FDE — pairing, reviewing, and shipping until agentic patterns become muscle memory.', m: 'EMBEDDED · HANDS-ON' }
    ],
    prodTitle: 'Tools for agentic builders.',
    prodKicker: 'field-tested, no fluff',
    products: [
      { tag: 'DIGITAL BOOK', t: 'The Vibe Coding Playbook', d: 'A field manual of prompts, patterns, and anti-patterns for shipping real software with AI.', cta: 'Get the book' },
      { tag: 'TOOLKIT', t: 'Ontology Canvas', d: 'A structured worksheet system for mapping your enterprise into an agent-readable ontology.', cta: 'Explore the canvas' },
      { tag: 'FREE', t: 'Agent Launch Checklist', d: 'The pre-flight list I run before any agentic app touches production.', cta: 'Download free' },
      { tag: 'PLATFORM', t: 'Deep Agents', d: 'Long-horizon agents that decompose goals, spawn sub-agents, and persist state across days of work — built for enterprise workflows.', cta: 'Request a demo' },
      { tag: 'TOOL', t: 'Ontology Generator', d: 'Point it at your systems and docs — it drafts an agent-readable ontology of entities, actions, and permissions for your engineers to refine.', cta: 'Request access' }
    ],
    coachTitle: 'Learn to think in agents.',
    coachKicker: 'for leaders and builders',
    coaching: [
      { m: 'FOR LEADERS · 1:1', t: 'Executive Coaching', d: 'Private sessions for leaders making AI bets: strategy, vendor truth-telling, and what to build versus buy.', cta: 'Request a slot' },
      { m: 'FOR DEVELOPERS · COHORT', t: 'Vibe Coding Bootcamp', d: 'Four weeks from AI-curious to shipping agentic apps — live sessions, real codebases, brutal code review.', cta: 'Join the waitlist' },
      { m: 'FOR TEAMS · ON-SITE', t: 'Team Workshops', d: 'One- and two-day intensives that rewire how a team builds with AI — on your codebase, not toy demos.', cta: 'Book a workshop' }
    ],
    ideasTitle: 'Ideas worth arguing with.',
    ideasKicker: 'essays in progress',
    ideas: [
      { t: 'Ontology is the new schema', d: 'Databases described your data. Ontologies describe your business. Agents need the latter.' },
      { t: 'Prompting is not programming. Orchestration is.', d: 'The unit of engineering is shifting from the function to the agent loop.' },
      { t: 'The FDE mindset', d: 'Why the best consultants now ship code from inside the building.' },
      { t: 'Slop is a choice', d: 'AI does not produce mediocrity. Unexamined taste does.' }
    ],
    ...
    posts: [
      { d: 'MAY 2026 · PLAYBOOK', t: 'Launching your first agentic app: a 90-day plan' },
      { d: 'APR 2026 · ONTOLOGY', t: 'Five ontology mistakes that quietly break agents' },
      { d: 'MAR 2026 · FIELD NOTES', t: 'What I learned embedding as an FDE at a Fortune 100' }
    ],
  ...
  'zh-CN': {
    ...
    services: [
      { n: '01', t: 'AI 应用落地', d: '选定一个高价值场景，从白板推进到上线应用——你的团队全程参与、同步成长。', m: '6–12 周 · 以结果为导向' },
      { n: '02', t: '智能体架构与本体论', d: '设计企业未来运行的本体：实体、动作、权限，以及在其上运行的智能体。', m: '咨询 · 架构' },
      { n: '03', t: '前线部署工程', d: '我以 FDE 身份嵌入你的工程团队——结对、评审、交付，直到智能体范式成为肌肉记忆。', m: '驻场 · 实战' }
    ],
    prodTitle: '给智能体建造者的工具。',
    prodKicker: '实战检验，拒绝空谈',
    products: [
      { tag: '数字书', t: 'Vibe Coding 实战手册', d: '一本关于提示词、模式与反模式的实战手册，教你用 AI 交付真正的软件。', cta: '获取本书' },
      { tag: '工具包', t: '本体论画布', d: '一套结构化工作表，把你的企业映射为智能体可读的本体。', cta: '了解画布' },
      { tag: '免费', t: '智能体上线清单', d: '每个智能体应用进入生产环境前，我都会过一遍的检查清单。', cta: '免费下载' },
      { tag: '平台', t: 'Deep Agents', d: '能拆解目标、派生子智能体、并跨数天持续推进工作的长程智能体——为企业工作流而生。', cta: '预约演示' },
      { tag: '工具', t: '本体生成器', d: '把它指向你的系统与文档——它会起草一份智能体可读的本体（实体、动作、权限），交给工程师精修。', cta: '申请使用' }
    ],
    coachTitle: '学会用智能体思考。',
    coachKicker: '写给领导者与建造者',
    coaching: [
      { m: '领导者 · 1:1', t: '高管教练', d: '为正在下注 AI 的决策者提供私人辅导：战略、供应商的真话，以及自研还是采购。', cta: '预约时段' },
      { m: '开发者 · 训练营', t: 'Vibe Coding 训练营', d: '四周时间，从「对 AI 好奇」到交付智能体应用——直播授课、真实代码库、毫不留情的代码评审。', cta: '加入候补' },
      { m: '团队 · 驻场', t: '团队工作坊', d: '一到两天的深度集训，重塑团队用 AI 构建的方式——在你们的代码库上，而不是玩具示例。', cta: '预订工作坊' }
    ],
    ideasTitle: '值得争论的观点。',
    ideasKicker: '持续写作中',
    ideas: [
      { t: '本体论是新的 Schema', d: '数据库描述你的数据，本体论描述你的业务。智能体需要后者。' },
      { t: '提示词不是编程，编排才是。', d: '工程的基本单元，正在从函数转向智能体循环。' },
      { t: 'FDE 心法', d: '为什么最好的顾问，如今都在客户内部写代码。' },
      { t: '平庸是一种选择', d: 'AI 不生产平庸，未经审视的品味才会。' }
    ],
    ...
    blogKicker: '来自真实部署',
    posts: [
      { d: '2026年5月 · 实战手册', t: '上线你的第一个智能体应用：90 天计划' },
      { d: '2026年4月 · 本体论', t: '悄悄搞坏智能体的五个本体论错误' },
      { d: '2026年3月 · 一线笔记', t: '在世界五百强做 FDE，我学到了什么' }
    ],
  ...
  'zh-TW': {
    ...
    services: [
      { n: '01', t: 'AI 應用落地', d: '選定一個高價值場景，從白板推進到上線應用——你的團隊全程參與、同步成長。', m: '6–12 週 · 以成果為導向' },
      { n: '02', t: '代理架構與本體論', d: '設計企業未來運行的本體：實體、動作、權限，以及在其上運作的 AI 代理。', m: '顧問 · 架構' },
      { n: '03', t: '前線部署工程', d: '我以 FDE 身分嵌入你的工程團隊——結對、審查、交付，直到代理式開發成為肌肉記憶。', m: '駐點 · 實戰' }
    ],
    prodTitle: '給代理建造者的工具。',
    prodKicker: '實戰驗證，拒絕空談',
    products: [
      { tag: '數位書', t: 'Vibe Coding 實戰手冊', d: '一本關於提示詞、模式與反模式的實戰手冊，教你用 AI 交付真正的軟體。', cta: '取得本書' },
      { tag: '工具組', t: '本體論畫布', d: '一套結構化工作表，把你的企業映射為 AI 代理可讀的本體。', cta: '了解畫布' },
      { tag: '免費', t: '代理上線檢查表', d: '每個代理式應用進入正式環境前，我都會跑一遍的檢查清單。', cta: '免費下載' },
      { tag: '平台', t: 'Deep Agents', d: '能拆解目標、衍生子代理、並跨數天持續推進工作的長程 AI 代理——為企業工作流而生。', cta: '預約展示' },
      { tag: '工具', t: '本體生成器', d: '把它指向你的系統與文件——它會草擬一份 AI 代理可讀的本體（實體、動作、權限），交給工程師精修。', cta: '申請使用' }
    ],
    coachTitle: '學會用代理思考。',
    coachKicker: '寫給領導者與建造者',
    coaching: [
      { m: '領導者 · 1:1', t: '高階主管教練', d: '為正在押注 AI 的決策者提供一對一輔導：策略、供應商的真話，以及自建還是採購。', cta: '預約時段' },
      { m: '開發者 · 共學營', t: 'Vibe Coding 訓練營', d: '四週時間，從「對 AI 好奇」到交付代理式應用——直播課程、真實程式庫、毫不留情的程式碼審查。', cta: '加入候補' },
      { m: '團隊 · 駐點', t: '團隊工作坊', d: '一到兩天的深度集訓，重塑團隊用 AI 開發的方式——在你們的程式庫上，而不是玩具範例。', cta: '預約工作坊' }
    ],
    ideasTitle: '值得爭論的觀點。',
    ideasKicker: '持續寫作中',
    ideas: [
      { t: '本體論是新的 Schema', d: '資料庫描述你的資料，本體論描述你的業務。AI 代理需要後者。' },
      { t: '提示詞不是程式設計，編排才是。', d: '工程的基本單位，正從函式轉向代理迴圈。' },
      { t: 'FDE 心法', d: '為什麼最好的顧問，如今都在客戶內部寫程式。' },
      { t: '平庸是一種選擇', d: 'AI 不會生產平庸，未經審視的品味才會。' }
    ],
    podTitle: 'The Agentic Hour',
    podKicker: '來自前線的對話',
    ...
    blogKicker: '來自真實部署',
    posts: [
      { d: '2026年5月 · 實戰手冊', t: '上線你的第一個代理式應用：90 天計畫' },
      { d: '2026年4月 · 本體論', t: '悄悄弄壞 AI 代理的五個本體論錯誤' },
      { d: '2026年3月 · 第一線筆記', t: '在《財星》百大企業擔任 FDE，我學到了什麼' }
    ],
